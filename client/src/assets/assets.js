...
export const categories = [  // categories boxes under the mainbanner
  {
    text: "Organic veggies",
    path: "Vegetables",
    image: organic_vegitable_image,
    bgColor: "#FEF6DA",
    info: "Fresh, chemical-free vegetables straight from the farm."
  },
  {
    text: "Fresh Fruits",
    path: "Fruits",
    ...
    bgColor: "#FEE0E0",
    info: "Juicy, ripe fruits to boost your daily nutrition."
  },
  {
    text: "Cold Drinks",
    path: "Drinks",
    image: bottles_image,
    bgColor: "#F0F5DE",
    info: "Refreshing beverages to quench your thirst anytime."
  },
  {
    text: "Instant Food",
    path: "Instant",
    image: maggi_image,
    bgColor: "#E1F5EC",
    info: "Quick and tasty meals ready in minutes."
  },
  {
    text: "Dairy Products",
    path: "Dairy",
    ...
    bgColor: "#FEE6CD",
    info: "High-quality milk, cheese, and other dairy essentials."
  },
  {
    text: "Bakery & Breads",
    path: "Bakery",
    image: bakery_image,
    bgColor: "#E0F6FE",
    info: "Freshly baked breads, pastries, and desserts daily."
  },
  {
    text: "Grains & Cereals",
    path: "Grains",
    image: grain_image,
    bgColor: "#F1E3F9",
    info: "Nutritious grains and cereals for healthy meals."
  },
];

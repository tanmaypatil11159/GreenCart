...
const InputField = (({name, handleChange, placeholder, type, address})=>(
        ...
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            ...
            <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
             ...
             <div className='grid grid-cols-2 gap-4'>
               ...
               <InputField handleChange = {handleChange} address = {address} 
                name = "phone" type = "number" placeholder = "Phone Number (+91)"/>

                <button type="submit" className='w-full rounded-lg mt-6 bg-primary text-white py-3 hover:bg-primary-dull transiton cursor-pointer uppercase'>
                    Save Address
                </button>
